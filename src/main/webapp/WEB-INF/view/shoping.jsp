...
<body>
	...
	<header>
						...
						<div class="row">
							...
							<c:forEach items="${allitem}" var="prod">
								<div class="span3">
									<div class="wrapper">
										<div class="testimonial">
											<img style="height: 219px;" src="img/productpng/appleiphone.jpeg" alt="" />
										</div>
										<br />
										<div align="center">
											...
											<button type="button" class="btn btn-primary btn"
												...
												onclick="addItem('${user.getId()}','${prod.id}','${prod.quantity}','${prod.price}')">+</button>
		...
		<script type="text/javascript">
			...
			function addItem(userid,itemid,itemquantity,itemprice) {
				...
				selecteditem= selecteditem + 1;
				alert("add item in cart"+selecteditem);
	...
	<a href="#" class="scrollup"><i
		...
		<script>
		function changestatus(userid,itemid) {
			alert(userid + "----" + itemid);
			$.ajax({
				url : "add-card-items?userid=" + userid +"&itemid=" +itemid,
				type:"GET",
