				...
				<div class="row">
					<div class="span12">
						<ul>
							...
							<li>Call us <i class="icon-phone"></i>+916554782548
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div id="mySignup" class="modal styled hide fade" tabindex="-1"
							...
							<div class="modal-body">
								...
								<form id="singup" class="form-horizontal" action="register"
									method="post" >
									...
									<div class="control-group">
										...
										<label class="control-label" for="inputContact">Contact
											No.</label>
										<div class="controls">
									...
									<div class="control-group">
										<label class="control-label" for="inputdob">Date of
											Birth</label>
										<div class="controls">
											<input type="Date" id="dob" name="dob"
												placeholder="Enter your birthdays" required>
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="radio" value="male" id="gender1" name="gender"
												required> Male &nbsp &nbsp <input type="radio"
												value="female" id="gender2" name="gender" required>
											Female
										</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="password" id="cpassword"
												placeholder="Confirm Password" required name="cpassword">
										</div>
								...
								<script type="text/javascript">
									function formValidation() 
									{
										...
										if (contact == "") {
											...
											document.getElementById("scontact").innerHTML = "*please enter contact no.";
										...
										if (contact.length != 10) {
											document.getElementById("scontact").innerHTML = "*please enter 10 digits  contact no.";
											return false;
										}

										if (dob == "") {

											document.getElementById("sdob").innerHTML = "*Please enter your dob";
											return false;
										}
										...
										{
											document
													.getElementById("spassword").innerHTML = "*Please Enter your password";
										...
										{
											document
													.getElementById("scpassword").innerHTML = "*Please Enter your confirm password";
										...
										if (password != cpassword) {
											...
											document
													.getElementById("spassword").innerHTML = "*passowrd must be same";
											document
													.getElementById("scpassword").innerHTML = "*passowrd must be same";
							...
							<div class="modal-body">
								<form class="form-horizontal" action="resetPassword"method="post">
									<div class="control-group">
										...
										<div class="controls">
											<input type="email" id="inputResetEmail" name="email"
									...
									<div class="control-group">
										...
										<p class="aligncenter margintop20" style="color: red">We
											will send the password to your register email id.</p>
									</div>
								</form>
							</div>
						</div>
					...
					<div class="span8">
						<div class="navbar navbar-static-top">
							<div class="navigation">
								<nav>
									<ul class="nav topnav">
										<li class="dropdown active"><a href="index.html">Home
					...
					<div class="row">
						<div class="span12">
							...
							<div class="nivo-caption" id="caption-1">
								<div>
									<h2>
										Awesome <strong>features</strong>
									</h2>
									<p>Lorem ipsum dolor sit amet nsectetuer nec Vivamus.
										Curabitu laoreet amet eget. Viurab oremd ellentesque ameteget.
										Lorem ipsum dolor sit amet nsectetuer nec vivamus.</p>
							...
							<div class="nivo-caption" id="caption-2">
								<div>
									<h2>
										Fully <strong>responsive</strong>
									</h2>
									<p>Lorem ipsum dolor sit amet nsectetuer nec Vivamus.
										Curabitu laoreet amet eget. Viurab oremd ellentesque ameteget.
										Lorem ipsum dolor sit amet nsectetuer nec vivamus.</p>
							...
							<div class="nivo-caption" id="caption-3">
								<div>
									<h2>
										Very <strong>customizable</strong>
									</h2>
									<p>Lorem ipsum dolor sit amet nsectetuer nec Vivamus.
										Curabitu laoreet amet eget. Viurab oremd ellentesque ameteget.
										Lorem ipsum dolor sit amet nsectetuer nec vivamus.</p>
				...
				<div class="row">
					<div class="span12">
						<div class="big-cta">
							<div class="cta-text">
								<h3>
									We've created more than <span class="highlight"><strong>5000
											websites</strong></span> this year!
								</h3>
							</div>
							<div class="cta floatright">
								<a class="btn btn-large btn-theme btn-rounded" href="#">Request
									a quote</a>
							</div>
						</div>
					</div>
		...
		<section id="content">
			<div class="container">
							...
							<div class="span3">
								<div class="box aligncenter">
									...
									<div class="text">
										...
										<p>Lorem ipsum dolor sit amet, has ei ipsum scaevola
											deseruisse am sea facilisis.</p>
										<a href="#">Learn more</a>
									</div>
								</div>
							</div>
							...
							<section id="projects">
								<ul id="thumbs" class="portfolio">
									...
									<li class="item-thumbs span3 design" data-id="id-0"
										...
										title="The City" href="img/works/full/image-01-full.jpg">
									...
									<li class="item-thumbs span3 design" data-id="id-1"
										...
										<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
										class="hover-wrap fancybox" data-fancybox-group="gallery"
										title="The Office" href="img/works/full/image-02-full.jpg">
											<span class="overlay-img"></span> <span
											class="overlay-img-thumb font-icon-plus"></span>
									</a> <!-- Thumb Image and Description --> <img
									...
									<li class="item-thumbs span3 photography" data-id="id-4"
										...
										<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
										class="hover-wrap fancybox" data-fancybox-group="gallery"
										title="The Sea" href="img/works/full/image-05-full.jpg"> <span
									...
									<li class="item-thumbs span3 photography" data-id="id-5"
										...
										<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
										class="hover-wrap fancybox" data-fancybox-group="gallery"
										title="Clouds" href="img/works/full/image-06-full.jpg"> <span
											class="overlay-img"></span> <span
											class="overlay-img-thumb font-icon-plus"></span>
									</a> <!-- Thumb Image and Description --> <img
									...
									<li class="item-thumbs span3 design" data-id="id-0"
										...
										<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
										class="hover-wrap fancybox" data-fancybox-group="gallery"
										title="The Dark" href="img/works/full/image-08-full.jpg">
											<span class="overlay-img"></span> <span
											class="overlay-img-thumb font-icon-plus"></span>
									</a> <!-- Thumb Image and Description --> <img
				...
				<div class="row">
					<div class="span12">
						<h4>
							Very satisfied <strong>clients</strong>
						</h4>
						<ul id="mycarousel"
							class="jcarousel-skin-tango recent-jcarousel clients">
							<li><a href="#"> <img
									src="img/dummies/clients/client1.png" class="client-logo"
									alt="" />
							</a></li>
							<li><a href="#"> <img
									src="img/dummies/clients/client2.png" class="client-logo"
									alt="" />
							</a></li>
							<li><a href="#"> <img
									src="img/dummies/clients/client3.png" class="client-logo"
									alt="" />
							</a></li>
							<li><a href="#"> <img
									src="img/dummies/clients/client4.png" class="client-logo"
									alt="" />
							</a></li>
							<li><a href="#"> <img
									src="img/dummies/clients/client5.png" class="client-logo"
									alt="" />
							</a></li>
							<li><a href="#"> <img
									src="img/dummies/clients/client6.png" class="client-logo"
									alt="" />
							</a></li>
							<li><a href="#"> <img
									src="img/dummies/clients/client1.png" class="client-logo"
